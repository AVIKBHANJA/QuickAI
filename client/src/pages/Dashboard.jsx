        ...
        <div className='space-y-4'>
          <div className='flex flex-col sm:flex-row gap-4 mt-6'>
            <div className='flex-1'>
              <p className='mb-4 text-lg font-medium'>Your Creations ({filteredCreations.length})</p>
            </div>
          </div>
          ...
          <div className='space-y-3'>
            {filteredCreations.length > 0 ? (
              filteredCreations.map((item) => <CreationItem key={item.id} item={item}/>)
            ) : (
              <div className='text-center py-8 text-gray-500'>
                {searchTerm || selectedType !== 'all' ? (
                  ...
                  <div>
                    ...
                    <p className='text-sm'>Start creating content with our AI tools!</p>
                  </div>
                )}
              </div>
            )}
